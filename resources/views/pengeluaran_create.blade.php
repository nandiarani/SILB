...
@section('title')
<title>SILBan|Tambah Harga Baru</title>
@endsection
        ...
        <div class="card-body">
            <form class="form-horizontal form-material" action="{{url('pengeluaran')}}" method="POST">
                ...
                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="number" name="jumlah" id="jumlah" placeholder="" class="form-control form-control-line" required autofocus value="{{$today}}">
                        </div>
                </div>
                <div class="form-group">
                        <label class="col-md-12">Harga satuan</label>
                        <div class="col-md-12">
                            <input type="number" name="harga_satuan" id="harga_satuan" placeholder="" class="form-control form-control-line" required autofocus value="{{$today}}">
                        </div>
                </div>
                <div class="form-group">
                        <label class="col-md-12">Total</label>
                        <div class="col-md-12">
                            <input type="number" name="total" id="total" readonly placeholder="" class="form-control form-control-line" required autofocus value="{{$today}}">
                        </div>
                </div>
                <div class="form-group">
                        <div class="col-sm-12">
